...
boot.id = 'boot';
boot.innerHTML = '<div style="text-align:center"><h1 class="title" style="font-size:42px">Cell Survival</h1><div class="bar"><i></i></div></div>';
...
try {
  ...
  boot.innerHTML = `<div style="text-align:center;max-width:520px;padding:24px">
    <h1 class="title" style="font-size:36px">Cell Survival</h1>
